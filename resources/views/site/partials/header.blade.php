                        ...
                        <div class="textwidget">
                            <ul class="top_bar_info clearfix">
                                ...
                                <li class="hidden-info">
                                    <i class="fa fa-map-marker"></i> 2B/8, Pallabi, Mirpur, Dhaka
                                </li>
                            </ul>
                        </div>
                    </aside>
        ...
        <div class="container">
            ...
            <div class="width-logo sm-logo">
                <a href="#" title="Travel" rel="home">
                    <img src="{{asset('public/site/images/logo_sticky.png')}}" alt="Logo" width="474" height="130" class="logo_transparent_static">
                    <img src="{{asset('public/site/images/logo_sticky.png')}}" alt="Sticky logo" width="474" height="130" class="logo_sticky">
                </a>
            </div>
