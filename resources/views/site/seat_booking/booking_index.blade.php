                ...
                <div class="hotel-booking-search travel-booking-search travel-booking-style_1">
                    <form action="{{route('search_coach_site')}}" name="hb-search-form" action="#" id="tourBookingForm" method="POST">
                        ...
                        <ul class="hb-form-table">
                            ...
                            <li class="hb-form-field">
                                <div class="hb-form-field-input">
                                    <input type="text" name="date" value="{{isset($date) ? date('Y-m-d', strtotime($date)) : ''}}" id="from" placeholder="Date of Journey" autocomplete="off">
                                </div>
                            </li>
                            <li class="hb-form-field">
                                <div class="hb-form-field-input">
                                    <input type="text" name="return_date" value="" id="to" placeholder="Date of Return (Optional)" autocomplete="off">
                                </div>
                            </li>
        ...
        <div class="container two-column-respon padding-top-6x padding-bottom-6x">
            <div class="row">
                <table class="table table-striped custab">
                    ...
                    ?>
                    <tr>
                        <td> {{ date('F d, Y', strtotime($coach->date_time))}} {{ date('h:i A', strtotime($coach->date_time))}}  </td>
                        <td> 
                        ...
                        <td class="text-center">
                            <a id="view-seat-{{$coach->coach_id}}" class='btn button-success btn-xs' href="#"> View Seats</a> 
                        </td>
                    </tr>
                    <tr id="coach-{{$coach->coach_id}}" style="display: none">
                        <td colspan="9" class="seat_portal">
                            <form method="post" action="{{route('confirm_seat_site')}}">
                                {{csrf_field()}}
                                <div class="container">
                                    <div class="row">
...
<?= $coach->seat_map ?>
            ...
            click: function () {
                ...
                if (this.status() == 'available') {
                    ...
                    $('<tr><td><input type="hidden" name="seat_no[]" value="' + this.settings.id + '">' + this.settings.label + '</td><td>' + this.data().price + '</td><td> <button class="cancel-cart-item btn btn-danger btn-xs"><i class="fa fa-times"></i></button></td></tr>')
