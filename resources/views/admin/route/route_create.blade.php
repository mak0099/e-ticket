                    ...
                    <div class="form-wrap">
                        ...
                        <form action="{{route('route.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="route_number" value="{{old('route_number')}}" autofocus="">
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10">Route Name</label>
                                <input type="text" class="form-control" name="route_name" value="{{old('route_name')}}" autofocus="">
                            </div>
                            <div class="form-group">
