            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="form-wrap">
                        ...
                        <form action="{{route('cost_category.store')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="control-label mb-10">Cost Category Name</label>
                                <input type="text" class="form-control" name="cost_category_name" value="{{old('cost_category_name')}}" autofocus="">
                            </div>
