    ...
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">Add Coach</h6>
                </div>
                    ...
                    <div class="form-wrap">
                        ...
                        <form action="{{route('coach.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="coach_number" value="{{old('coach_number')}}" autofocus="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="0" class="form-control" name="fare" value="{{old('fare')}}">
                                </div>
                            </div>
