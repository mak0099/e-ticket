                    ...
                    <div class="form-wrap">
                        ...
                        <form action="{{route('car.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="car_number" value="{{old('car_number')}}" autofocus="">
                            </div>
                            <div class="form-group">
                                <label class="control-label mb-10">Car Brand</label>
                                <input type="text" class="form-control" name="car_brand" value="{{old('location')}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mb-30">
                                ...
                                <div class="radio radio-success">
                                    <input type="radio" name="coach_type"id="radio1" value="AC" {{old('coach_type') == 'AC' ? 'checked':''}}>
                                    <label for="radio1">
                                        AC
                                    </label>
                                </div>
                                <div class="radio radio-primary">
                                    <input type="radio" name="coach_type" id="radio2" value="Non-AC" {{old('coach_type') == 'Non-AC' ? 'checked':''}}>
                                    <label for="radio2">
                                        Non-AC
                                    </label>
                                </div>	
